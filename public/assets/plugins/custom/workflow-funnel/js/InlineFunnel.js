...
InlineFunnel.prototype = auxlib.create (BaseFunnel.prototype);
...
InlineFunnel.prototype._addInteractionButtons = function () {
    ...
    */
    ...
    for (var i = 0; i < this.stageCount; i++) {
        var previousCheck = workflowManager.checkStageRequirement (i + 1, this.workflowStatus);
        ...
        if (this.workflowStatus.stages[i+1]['createDate'] !== null) { // if started
            ...
            revertButton.bind (
                'click', wrapWorkflowMethod (i + 1, workflowManager.revertWorkflowStage));
                ...
                if (previousCheck && editPermission) { // can complete
                    ...
                    if (parseInt (this.stagesWhichRequireComments[i], 10)) {
                        completeButton.click (
                            wrapWorkflowMethod (i + 1, workflowManager.workflowCommentDialog));
                    } else {
                        completeButton.click (
                            wrapWorkflowMethod (i + 1, workflowManager.completeWorkflowStage));
                    }
            ...
            statusContainer.append ($('<a>', {
                ...
                var stageNumber = i + 1;
                return function () {
                    workflowManager.workflowStageDetails (
            ...
            if (editPermission && previousCheck) {
                ...
                startButton.click (
                    wrapWorkflowMethod (i + 1, workflowManager.startWorkflowStage));
