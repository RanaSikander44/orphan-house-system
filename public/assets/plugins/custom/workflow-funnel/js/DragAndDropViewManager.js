DragAndDropViewManager = (function () {
...
DragAndDropViewManager.prototype = auxlib.create (WorkflowManagerBase.prototype);
    ...
    $.ajax ({
        ...
        success: function (data) {
            ...
            if (data['flashes']['error'].length !== 0) {
                ...
                flashes.displayFlashes (data['flashes']);
            } else {
...
DragAndDropViewManager.prototype._permissionsFailureResponse = function (element) {
    ...
    flashes.displayFlashes ({'error': [this.translations.permissionsError]});
    that._successFailureAnimation ($(element), false);
};
...
DragAndDropViewManager.prototype._setUpAddADealButtonBehavior = function () {
            ...
            },
            {
                ...
                click: function () {
                    ...
                    if (valid) {
                        ...
                        var newDealType = modelNameToModuleName[$('#new-deal-type').val ()]
                            .toLowerCase ();
    ...
    $('#new-deal-type').unbind ('change._setUpAddADealButtonBehavior')
        ...
        forms.inputLoading ($('#record-name-container'));
        $.ajax ({
            type: 'GET',
            ...
            success: function (data) {
                forms.inputLoadingStop ($('#record-name-container'));
...
DragAndDropViewManager.prototype._setUpQtips = function () {
    ...
    $.each (['opportunities', 'contacts', 'accounts'], function (i, type) {
        that._qtipManagers[type] = new X2GridViewQtipManager ({
...
DragAndDropViewManager.prototype._init = function () {
    ...
    flashes.successFadeTimeout = 500;
