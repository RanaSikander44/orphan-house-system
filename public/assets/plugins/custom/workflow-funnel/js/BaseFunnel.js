...
function BaseFunnel (argsDict) {
    ...
    var defaultArgs = {
        ...
        containerNameSelector: null, // element selector for container which will hold the funnel
        containerAmountSelector: null, // element selector for container which will hold the funnel
        containerSummarySelector: null, // element selector for container which will hold the funnel
        workflowStatus: null,
    ...
    this._stageHeights = 50; // heights of individual stages
    this._stageHeight = 30; // temporary. replace when stage heights are depend on status
    //this._funnelHeight = 200;
    this._funnelHeight = 200;
    this._funnelW1 = 450; // width of top of funnel
    this._funnelW2 = 230; // width of bottom of funnel
