            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addCityModal">Add
                            City</button>
                    </div>
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($cities as $city)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#editCityModal{{ $city->id }}">Edit</button>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#deleteCityModal{{ $city->id }}">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <!-- Delete City Modal -->
                                <div class="modal fade" id="deleteCityModal{{ $city->id }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
