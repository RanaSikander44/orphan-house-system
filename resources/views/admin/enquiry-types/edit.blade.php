...
@section('Page-title', 'Edit Enquiry Types')
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <form action="{{ route('enquiry-types.update', $enquiryEdit->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <!-- Year Input -->
                        <div class="mb-3">
                            <label for="year" class="form-label">Title <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="title" value="{{ $enquiryEdit->title }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="" class="form-control">
                                <option value="1" {{ $enquiryEdit->status === '1' ? 'Selected' : ''}}>Active</option>
                                <option value="0" {{ $enquiryEdit->status === '0' ? 'Selected' : ''}}>Inactive</option>
                            </select>
                        </div>
                        <!-- Submit Button -->
