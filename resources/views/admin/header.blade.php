...
<div id="sidebar">
    <div class="bg-white border-end sidebar-content">
        <ul class="list-group list-group-flush my-ul pt-4">
            ...
            <li class="avatar">
                <div class="image" style="width: 100px; height: 100px; border-radius: 0px; object-fit: cover; border: 2px solid #ddd; background-color: #f8f9fa;">
                    <img src="{{ asset(Auth::user()->profile_photo) }}" alt="avatar" class="rounded" style="width: 100%; height: 100%; object-fit: cover;" />
                </div>
