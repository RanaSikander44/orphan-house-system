  ...
  <div class="offcanvas-content pr-5 mr-n5">
    <div class="d-flex align-items-center mt-5">
      ...
      <div class="d-flex flex-column">
        <a href="#"
          class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::user() ? Auth::user()->name : '??' }}</a>
        <div class="text-muted mt-1">{{$jobRoleTitle}}</div>
        <div class="navi mt-2">
          ...
          <a class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" href="javascript:;"
            onclick="document.getElementById('logout-form').submit();">{{__('common.sign_out')}}</a>
          <form id="logout-form-up" action="{{ route('logout') }}" method="POST" style="display: none;">
            @csrf
          </form>
        </div>
      </div>
    ...
    <div class="navi navi-spacer-x-0 p-0">
      <a href="{{url('update-profile')}}" class="navi-item d-none">
        <div class="navi-link">
      ...
      <a href="{{url('/admin/change-password')}}" class="navi-item">
        <div class="navi-link">
          <div class="symbol symbol-40 bg-light mr-3">
            <div class="symbol-label">
              <span class="svg-icon svg-icon-md svg-icon-primary">
                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <g id="Stockholm-icons-/-General-/-Lock" stroke="none" stroke-width="1" fill="none"
                    fill-rule="evenodd">
